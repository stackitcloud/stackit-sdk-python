...
class ListDistributionsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["distributions", "nextPageIdentifier"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListDistributionsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListDistributionsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "distributions": (
                    [Distribution.from_dict(_item) for _item in obj["distributions"]]
