...
from stackit.cdn.models.waf_violation import WAFViolation
...
class DistributionLogsRecord(BaseModel):
    ...
    timestamp: datetime
    waf_violation: Optional[WAFViolation] = Field(default=None, alias="wafViolation")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of waf_violation
        if self.waf_violation:
            _dict["wafViolation"] = self.waf_violation.to_dict()
        return _dict
        ...
        _obj = cls.model_validate(
            {
                ...
                "wafViolation": (
                    WAFViolation.from_dict(obj["wafViolation"]) if obj.get("wafViolation") is not None else None
                ),
            }
        )
        return _obj
