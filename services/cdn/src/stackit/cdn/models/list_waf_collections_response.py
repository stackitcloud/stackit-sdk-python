...
class ListWAFCollectionsResponse(BaseModel):
    """
    ListWAFCollectionsResponse
    """  # noqa: E501

    collections: List[WAFRuleCollection]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListWAFCollectionsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListWAFCollectionsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "collections": (
                    [WAFRuleCollection.from_dict(_item) for _item in obj["collections"]]
