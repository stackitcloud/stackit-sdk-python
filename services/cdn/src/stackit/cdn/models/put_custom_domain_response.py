...
class PutCustomDomainResponse(BaseModel):
    """
    PutCustomDomainResponse
    """  # noqa: E501

    certificate: Optional[PutCustomDomainResponseCertificate] = None
    custom_domain: CustomDomain = Field(alias="customDomain")
    __properties: ClassVar[List[str]] = ["certificate", "customDomain"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PutCustomDomainResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PutCustomDomainResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "certificate": (
                    PutCustomDomainResponseCertificate.from_dict(obj["certificate"])
