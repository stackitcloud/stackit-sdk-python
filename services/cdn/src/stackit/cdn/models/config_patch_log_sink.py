...
class ConfigPatchLogSink(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        instance = ConfigPatchLogSink.model_construct()
        error_messages = []
        match = 0
        # validate data type: LokiLogSinkPatch
        if not isinstance(v, LokiLogSinkPatch):
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        ...
        # deserialize data into LokiLogSinkPatch
        try:
            instance.actual_instance = LokiLogSinkPatch.from_json(json_str)
            match += 1
