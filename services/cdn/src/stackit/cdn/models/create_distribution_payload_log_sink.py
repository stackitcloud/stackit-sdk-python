...
class CreateDistributionPayloadLogSink(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = CreateDistributionPayloadLogSink.model_construct()
        error_messages = []
        match = 0
        # validate data type: LokiLogSinkCreate
        if not isinstance(v, LokiLogSinkCreate):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into LokiLogSinkCreate
        try:
            instance.actual_instance = LokiLogSinkCreate.from_json(json_str)
            match += 1
