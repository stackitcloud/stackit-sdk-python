...
class ListTopicsResponse(BaseModel):
    ...
    next_page_token: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = Field(
        default=None, description="A token to retrieve the next page of results.", alias="nextPageToken"
    )
    topics: List[TopicResponse]
    __properties: ClassVar[List[str]] = ["nextPageToken", "topics"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "topics": (
                    [TopicResponse.from_dict(_item) for _item in obj["topics"]]
