...
class UpdateTopicPayload(BaseModel):
    ...
    display_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=36)]] = Field(
        default=None,
    ...
    settings: Optional[TopicSettings] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateTopicPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateTopicPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "settings": TopicSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None,
            }
        )
        return _obj
