...
import stackit.pubsub.models
from stackit.pubsub import rest
from stackit.pubsub.api_response import ApiResponse
from stackit.pubsub.api_response import T as ApiResponseT
from stackit.pubsub.configuration import HostConfiguration
from stackit.pubsub.exceptions import (
    ApiException,
)
...
class ApiClient:
    ...
    def __init__(self, configuration, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "stackit-sdk-python/pubsub"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.pubsub.models, klass)
