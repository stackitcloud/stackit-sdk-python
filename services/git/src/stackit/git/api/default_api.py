...
from stackit.git.models.update_user_payload import UpdateUserPayload
...
class DefaultApi:
    ...
    def create_authentication(
        ...
        instance_id: Annotated[UUID, Field(description="Instance identifier.")],
    ...
    def create_user(
        ...
        project_id: Annotated[UUID, Field(description="Project identifier.")],
        instance_id: Annotated[UUID, Field(description="Instance identifier.")],
        create_user_payload: Annotated[CreateUserPayload, Field(description="Instance User details options.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        """Create an Instance Local/Technical User.
        ...
        :param instance_id: Instance identifier. (required)
        :type instance_id: UUID
        :param create_user_payload: Instance User details options. (required)
    ...
    def _create_user_serialize(
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/v1beta/projects/{projectId}/instances/{instanceId}/users",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_authentication(
        ...
        project_id: Annotated[UUID, Field(description="Project identifier.")],
        instance_id: Annotated[UUID, Field(description="Instance identifier.")],
        authentication_id: Annotated[UUID, Field(description="Authentication Source identifier.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
    ...
    def delete_user(
        ...
        project_id: Annotated[UUID, Field(description="Project identifier.")],
        instance_id: Annotated[UUID, Field(description="Instance identifier.")],
        username: Annotated[StrictStr, Field(description="Instance User identifier.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param instance_id: Instance identifier. (required)
        :type instance_id: UUID
        :param username: Instance User identifier. (required)
        :type username: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _delete_user_serialize(
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/v1beta/projects/{projectId}/instances/{instanceId}/users/{username}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_users(
        ...
        page: Annotated[
            ...
            Field(description="Page number for pagination (1-indexed). Each page contains up to 50 users."),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Lists STACKIT Git Users within an instance. Supports pagination via the optional `page` query parameter. Each page returns up to 50 users.

        :param project_id: Project identifier. (required)
        :type project_id: UUID
        :param instance_id: Instance identifier. (required)
        :type instance_id: UUID
        :param page: Page number for pagination (1-indexed). Each page contains up to 50 users.
        :type page: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
