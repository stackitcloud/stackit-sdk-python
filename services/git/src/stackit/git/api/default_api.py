...
class DefaultApi:
    ...
    def patch_user(
        ...
        instance_id: Annotated[UUID, Field(description="Instance identifier.")],
        username: Annotated[StrictStr, Field(description="Instance User identifier.")],
        patch_user_payload: PatchUserPayload,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param username: Instance User identifier. (required)
        :type username: str
        :param patch_user_payload: (required)
        :type patch_user_payload: PatchUserPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_user_serialize(
            ...
            instance_id=instance_id,
            username=username,
            patch_user_payload=patch_user_payload,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    def _patch_user_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patch_user_payload is not None:
            _body_params = patch_user_payload
