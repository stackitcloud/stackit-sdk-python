...
class CreateSharePayload(BaseModel):
    ...
    export_policy_name: Optional[StrictStr] = Field(
        default=None,
        description="Name of the Share Export Policy to use in the Share.   Note that if this is not set, the Share can only be mounted in read only by clients with IPs matching the  IP ACL of the Resource Pool hosting this Share. You can also assign a Share Export Policy after creating  the Share",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateSharePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateSharePayload from a dict"""
        if obj is None:
            return None
