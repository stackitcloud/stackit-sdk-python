...
class GetResourcePoolSnapshotResponse(BaseModel):
    """
    GetResourcePoolSnapshotResponse
    """  # noqa: E501

    resource_pool_snapshot: Optional[ResourcePoolSnapshot] = Field(
        default=None, description="Resource Pool Snapshot", alias="resourcePoolSnapshot"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetResourcePoolSnapshotResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetResourcePoolSnapshotResponse from a dict"""
        if obj is None:
            return None
