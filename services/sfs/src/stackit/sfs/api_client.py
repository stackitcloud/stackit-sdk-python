...
import stackit.sfs.models
from stackit.sfs import rest
from stackit.sfs.api_response import ApiResponse
from stackit.sfs.api_response import T as ApiResponseT
from stackit.sfs.configuration import HostConfiguration
from stackit.sfs.exceptions import (
    ApiException,
)
...
class ApiClient:
    ...
    def __init__(self, configuration, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "stackit-sdk-python/sfs"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.sfs.models, klass)
