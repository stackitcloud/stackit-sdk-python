...
class UpdateCredentialsPayload(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateCredentialsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateCredentialsPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"displayName": obj.get("displayName"), "password": obj.get("password"), "username": obj.get("username")}
        )
        return _obj
