...
import stackit.loadbalancer.models
from stackit.loadbalancer import rest
from stackit.loadbalancer.api_response import ApiResponse
from stackit.loadbalancer.api_response import T as ApiResponseT
from stackit.loadbalancer.configuration import HostConfiguration
from stackit.loadbalancer.exceptions import (
    ApiException,
)
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.loadbalancer.models, klass)
