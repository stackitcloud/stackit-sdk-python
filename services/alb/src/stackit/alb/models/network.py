...
class Network(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["networkId", "role"]
    ...
    def role_validate_enum(cls, value):
        ...
        if value not in set(["ROLE_UNSPECIFIED", "ROLE_LISTENERS_AND_TARGETS", "ROLE_LISTENERS", "ROLE_TARGETS"]):
            raise ValueError(
                "must be one of enum values ('ROLE_UNSPECIFIED', 'ROLE_LISTENERS_AND_TARGETS', 'ROLE_LISTENERS', 'ROLE_TARGETS')"
            )
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"networkId": obj.get("networkId"), "role": obj.get("role")})
        return _obj
