...
class HTTPConfig(BaseModel):
    ...
    sub_rules: Optional[List[SubRule]] = Field(default=None, alias="subRules")
    __properties: ClassVar[List[str]] = ["subRules"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in sub_rules (list)
        _items = []
        if self.sub_rules:
            for _item in self.sub_rules:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "subRules": (
                    [SubRule.from_dict(_item) for _item in obj["subRules"]] if obj.get("subRules") is not None else None
                )
            }
        )
        return _obj
