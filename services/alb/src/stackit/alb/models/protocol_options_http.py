...
class ProtocolOptionsHTTP(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProtocolOptionsHTTP from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProtocolOptionsHTTP from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"hosts": [HostConfig.from_dict(_item) for _item in obj["hosts"]] if obj.get("hosts") is not None else None}
        )
        return _obj
