...
import stackit.vpn.models
from stackit.vpn import rest
from stackit.vpn.api_response import ApiResponse
from stackit.vpn.api_response import T as ApiResponseT
from stackit.vpn.configuration import HostConfiguration
from stackit.vpn.exceptions import (
    ApiException,
)
...
class ApiClient:
    ...
    def __init__(self, configuration, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "stackit-sdk-python/vpn"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.vpn.models, klass)
