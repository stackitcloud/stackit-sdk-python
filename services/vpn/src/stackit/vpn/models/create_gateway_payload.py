...
class CreateGatewayPayload(BaseModel):
    """
    CreateGatewayPayload
    """  # noqa: E501

    availability_zones: CreateGatewayPayloadAvailabilityZones = Field(alias="availabilityZones")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateGatewayPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateGatewayPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "availabilityZones": (
                    CreateGatewayPayloadAvailabilityZones.from_dict(obj["availabilityZones"])
