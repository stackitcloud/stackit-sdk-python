...
class VPNTunnels(BaseModel):
    ...
    internal_next_hop_ip: Optional[StrictStr] = Field(
        default=None, description="The IPv4 address of the endpoint in the SNA.", alias="internalNextHopIP"
    )
    name: Optional[StrictStr] = None
    public_ip: Optional[StrictStr] = Field(
        default=None, description="The public IPv4 address of this endpoint.", alias="publicIP"
    )
    __properties: ClassVar[List[str]] = ["bgpStatus", "instanceState", "internalNextHopIP", "name", "publicIP"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "internalNextHopIP": obj.get("internalNextHopIP"),
                "name": obj.get("name"),
