...
class GetManagedRuleSetResponse(BaseModel):
    ...
    name: Annotated[str, Field(strict=True)] = Field(description="Managed rule set configuration name.")
    type: Type
    usage: Optional[MRSUsage] = None
    version: Annotated[str, Field(strict=True)] = Field(description="Managed rule set version.")
