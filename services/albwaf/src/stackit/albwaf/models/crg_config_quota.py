...
class CRGConfigQuota(BaseModel):
    """
    ...
    limit: Optional[Annotated[int, Field(le=1000000, strict=True, ge=-1)]] = Field(
        default=None, description="The maximum number of custom rule groups in this project."
    )
    usage: Optional[Annotated[int, Field(le=1000000, strict=True, ge=-1)]] = Field(
        default=None, description="The number of custom rule groups that are currently existing in this project."
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CRGConfigQuota from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CRGConfigQuota from a dict"""
        if obj is None:
            return None
