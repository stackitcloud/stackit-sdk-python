...
class GetWAFResponse(BaseModel):
    ...
    custom_rule_group_name: Annotated[str, Field(strict=True)] = Field(
        description="Name of the CRG configuration for that WAF.", alias="customRuleGroupName"
    )
    ...
    managed_rule_set_name: Annotated[str, Field(strict=True)] = Field(
        description="Name of the managed rule set configuration for that WAF.", alias="managedRuleSetName"
    )
