...
class CRGUsage(BaseModel):
    """
    Tracking metrics for CRG resource utilization
    """  # noqa: E501

    count: Optional[StrictInt] = Field(
        default=None, description="Number of WAF configurations actively using this rule group."
    )
    items: Optional[List[StrictStr]] = Field(
        default=None, description="List of individual WAF configuration names that bind this rule group."
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CRGUsage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CRGUsage from a dict"""
        if obj is None:
            return None
