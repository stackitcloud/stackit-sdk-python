...
class GetCustomRule(BaseModel):
    ...
    behavior: Optional[GetBehavior] = None
    conditions: Optional[List[Condition]] = Field(
        default=None, description="[HINT] Order matters! First condition match triggers execution."
    )
    description: StrictStr = Field(
        description="A clear description explaining the threat vector or criteria addressed by this rule."
    )
    id: StrictInt = Field(description="Backend auto-allocated unique rule ID within the valid 1-99999 threshold.")
    __properties: ClassVar[List[str]] = ["behavior", "conditions", "description", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "behavior": GetBehavior.from_dict(obj["behavior"]) if obj.get("behavior") is not None else None,
                "conditions": (
