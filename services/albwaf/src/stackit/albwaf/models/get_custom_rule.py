...
class GetCustomRule(BaseModel):
    """
    GetCustomRule
    """  # noqa: E501

    behaviour: Optional[GetBehaviour] = None
    conditions: Optional[List[Condition]] = Field(
        default=None, description="[HINT] Order matters! First condition match triggers execution."
    )
    description: Optional[StrictStr] = Field(
        default=None, description="A clear description explaining the threat vector or criteria addressed by this rule."
    )
    id: Optional[StrictInt] = Field(
        default=None, description="Backend auto-allocated unique rule ID within the valid 1-99999 threshold."
    )
    __properties: ClassVar[List[str]] = ["behaviour", "conditions", "description", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetCustomRule from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of behaviour
        if self.behaviour:
            _dict["behaviour"] = self.behaviour.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetCustomRule from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "behaviour": GetBehaviour.from_dict(obj["behaviour"]) if obj.get("behaviour") is not None else None,
                "conditions": (
