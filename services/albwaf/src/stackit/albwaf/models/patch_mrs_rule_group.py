...
class PatchMRSRuleGroup(BaseModel):
    """
    PatchMRSRuleGroup
    """  # noqa: E501

    rules: Optional[Dict[str, PatchMRSRule]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchMRSRuleGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchMRSRuleGroup from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "rules": (
                    dict((_k, PatchMRSRule.from_dict(_v)) for _k, _v in obj["rules"].items())
