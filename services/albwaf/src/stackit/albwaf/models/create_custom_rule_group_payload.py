...
class CreateCustomRuleGroupPayload(BaseModel):
    """
    Request payload for creating a CRG.
    """  # noqa: E501

    name: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Custom rule group name.")
    ...
    rules: Optional[List[CreateCustomRule]] = Field(
        default=None, description="The collection of custom rule group SecLang parameters forming this execution group."
    )
    __properties: ClassVar[List[str]] = ["name", "projectId", "region", "rules"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateCustomRuleGroupPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateCustomRuleGroupPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "rules": (
                    [CreateCustomRule.from_dict(_item) for _item in obj["rules"]]
