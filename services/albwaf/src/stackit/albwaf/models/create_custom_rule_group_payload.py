...
class CreateCustomRuleGroupPayload(BaseModel):
    ...
    name: Annotated[str, Field(strict=True)] = Field(description="Custom rule group name.")
    ...
    rules: List[CreateCustomRule] = Field(
        description="The collection of custom rule group SecLang parameters forming this execution group."
    )
