...
class ConditionOperator(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="The operational evaluation type definition macro.")
    value: Optional[StrictStr] = Field(
        default=None, description="The text or rule regex pattern arguments applied inside the operator execution loop."
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConditionOperator from a dict"""
        if obj is None:
            return None
