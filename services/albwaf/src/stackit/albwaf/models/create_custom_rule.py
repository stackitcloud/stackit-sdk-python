...
class CreateCustomRule(BaseModel):
    """
    CreateCustomRule
    """  # noqa: E501

    behaviour: Behaviour
    conditions: List[Condition] = Field(description="[HINT] Order matters! First condition match triggers execution.")
    description: Optional[StrictStr] = Field(
        default=None, description="A clear description explaining the threat vector or criteria addressed by this rule."
    )
    __properties: ClassVar[List[str]] = ["behaviour", "conditions", "description"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateCustomRule from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateCustomRule from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "behaviour": Behaviour.from_dict(obj["behaviour"]) if obj.get("behaviour") is not None else None,
                "conditions": (
