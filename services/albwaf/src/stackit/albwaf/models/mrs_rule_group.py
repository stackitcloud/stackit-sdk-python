...
class MRSRuleGroup(BaseModel):
    ...
    description: StrictStr = Field(description="A description of what this group covers.")
    group_name: Annotated[str, Field(strict=True)] = Field(
        description="The name for the rule group.", alias="groupName"
    )
