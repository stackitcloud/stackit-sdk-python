...
class MRSRuleGroup(BaseModel):
    """
    RuleGroup represents a collection of rules associated with a specific group.
    """  # noqa: E501

    description: Optional[StrictStr] = Field(default=None, description="A description of what this group covers.")
    group_name: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None, description="The name for the rule group.", alias="groupName"
    )
    rules: Optional[Dict[str, MRSRule]] = None
    __properties: ClassVar[List[str]] = ["description", "groupName", "rules"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MRSRuleGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MRSRuleGroup from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "rules": (
                    dict((_k, MRSRule.from_dict(_v)) for _k, _v in obj["rules"].items())
