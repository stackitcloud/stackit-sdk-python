...
class ListCustomRuleGroupResponse(BaseModel):
    """
    ListCustomRuleGroupResponse returns a list of Custom Rule Group responses.
    """  # noqa: E501

    items: Optional[List[GetCustomRuleGroupResponse]] = None
    next_page_id: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None,
        description="Continue token from the ListCustomRuleGroupResponse with Limit option",
        alias="nextPageId",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListCustomRuleGroupResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListCustomRuleGroupResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "items": (
                    [GetCustomRuleGroupResponse.from_dict(_item) for _item in obj["items"]]
