...
class UpdateWAFPayload(BaseModel):
    """
    UpdateWAFRequest updates a WAF if rules changed.
    """  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateWAFPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateWAFPayload from a dict"""
        if obj is None:
            return None
