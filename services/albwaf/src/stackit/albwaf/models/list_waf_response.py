...
class ListWAFResponse(BaseModel):
    """
    ListWAFResponse returns a list of WAF responses.
    """  # noqa: E501

    items: Optional[List[GetWAFResponse]] = None
    next_page_id: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None, description="Continue token from the ListWAFResponse with Limit option", alias="nextPageId"
    )
    __properties: ClassVar[List[str]] = ["items", "nextPageId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListWAFResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListWAFResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "items": (
                    [GetWAFResponse.from_dict(_item) for _item in obj["items"]]
