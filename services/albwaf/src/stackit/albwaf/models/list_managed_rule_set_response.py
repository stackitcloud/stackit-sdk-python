...
class ListManagedRuleSetResponse(BaseModel):
    """
    ListManagedRuleSetResponse returns a list of rule configuration responses.
    """  # noqa: E501

    items: Optional[List[GetLimitedManagedRuleSetResponse]] = None
    next_page_id: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None,
        description="Continue token from the ListManagedRuleSetResponse with Limit option",
        alias="nextPageId",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListManagedRuleSetResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListManagedRuleSetResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "items": (
                    [GetLimitedManagedRuleSetResponse.from_dict(_item) for _item in obj["items"]]
