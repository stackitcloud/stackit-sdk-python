...
class MRSUsage(BaseModel):
    """
    MRSUsage
    """  # noqa: E501

    count: Optional[StrictInt] = Field(default=None, description="Number of WAFs using this Managed Rule Set.")
    items: Optional[List[StrictStr]] = Field(default=None, description="List of WAFs that use this Managed Rule Set.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MRSUsage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MRSUsage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"count": obj.get("count"), "items": obj.get("items")})
        return _obj
