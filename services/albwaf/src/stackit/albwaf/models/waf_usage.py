...
class WAFUsage(BaseModel):
    """
    WAFUsage
    """  # noqa: E501

    count: Optional[StrictInt] = Field(default=None, description="Number of listeners using this WAF configuration.")
    items: Optional[List[WAFUsageItem]] = Field(
        default=None,
        description="List of Application Load Balancers with their associated listeners that use this WAF configuration.",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WAFUsage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WAFUsage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "count": obj.get("count"),
                "items": (
                    [WAFUsageItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
                ),
            }
        )
        return _obj
