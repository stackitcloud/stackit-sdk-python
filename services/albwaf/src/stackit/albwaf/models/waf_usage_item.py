...
class WAFUsageItem(BaseModel):
    ...
    listener_names: Optional[List[StrictStr]] = Field(
        default=None,
        description="The list of listener names in this Load Balancer, that are using the WAF.",
        alias="listenerNames",
    )
    load_balancer_name: StrictStr = Field(
        description="The display name of the Load Balancer.", alias="loadBalancerName"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WAFUsageItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WAFUsageItem from a dict"""
        if obj is None:
            return None
