...
import stackit.albwaf.models
from stackit.albwaf import rest
from stackit.albwaf.api_response import ApiResponse
from stackit.albwaf.api_response import T as ApiResponseT
from stackit.albwaf.configuration import HostConfiguration
from stackit.albwaf.exceptions import (
    ApiException,
)
...
class ApiClient:
    ...
    def __init__(self, configuration, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "stackit-sdk-python/albwaf"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.albwaf.models, klass)
