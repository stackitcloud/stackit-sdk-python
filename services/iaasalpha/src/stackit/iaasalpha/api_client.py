...
import stackit.iaasalpha.models
from stackit.iaasalpha import rest
from stackit.iaasalpha.api_response import ApiResponse
from stackit.iaasalpha.api_response import T as ApiResponseT
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.iaasalpha.models, klass)
