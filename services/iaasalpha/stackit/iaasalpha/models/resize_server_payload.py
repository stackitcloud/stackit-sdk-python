...
class ResizeServerPayload(BaseModel):
    """
    ResizeServerPayload
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResizeServerPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResizeServerPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"machineType": obj.get("machineType")})
        return _obj
