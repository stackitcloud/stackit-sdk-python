...
class GetServiceStatusResponse(BaseModel):
    """
    Response with customer project status.
    """

    status: Optional[StrictStr] = Field(default=None, description="status of the project")
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('STATUS_UNSPECIFIED', 'STATUS_READY', 'STATUS_FAILED', 'STATUS_UPDATING', 'STATUS_DELETING', 'STATUS_DISABLED', 'STATUS_PROJECT_UNKNOWN')"
            )
        return value
