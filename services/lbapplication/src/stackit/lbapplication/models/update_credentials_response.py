...
class UpdateCredentialsResponse(BaseModel):
    ...
    credential: Optional[CredentialsResponse] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateCredentialsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateCredentialsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "credential": (
                    CredentialsResponse.from_dict(obj["credential"]) if obj.get("credential") is not None else None
                )
            }
        )
        return _obj
