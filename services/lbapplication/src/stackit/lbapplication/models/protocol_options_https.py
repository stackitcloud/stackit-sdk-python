...
class ProtocolOptionsHTTPS(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["certificateConfig"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProtocolOptionsHTTPS from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of certificate_config
        if self.certificate_config:
            _dict["certificateConfig"] = self.certificate_config.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProtocolOptionsHTTPS from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "certificateConfig": (
                    CertificateConfig.from_dict(obj["certificateConfig"])
                    if obj.get("certificateConfig") is not None
                    else None
                )
            }
        )
