...
import stackit.logs.models
from stackit.logs import rest
from stackit.logs.api_response import ApiResponse
from stackit.logs.api_response import T as ApiResponseT
from stackit.logs.configuration import HostConfiguration
from stackit.logs.exceptions import (
    ApiException,
)
...
class ApiClient:
    ...
    def __init__(self, configuration, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "stackit-sdk-python/logs"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.logs.models, klass)
