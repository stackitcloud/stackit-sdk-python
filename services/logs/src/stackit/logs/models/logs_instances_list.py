...
class LogsInstancesList(BaseModel):
    """
    LogsInstancesList
    """  # noqa: E501

    instances: List[LogsInstance]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LogsInstancesList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LogsInstancesList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "instances": (
                    [LogsInstance.from_dict(_item) for _item in obj["instances"]]
