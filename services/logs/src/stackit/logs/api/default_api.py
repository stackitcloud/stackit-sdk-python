...
class DefaultApi:
    ...
    def create_access_policy(
        ...
        create_access_policy_payload: CreateAccessPolicyPayload,
        ...
        :param create_access_policy_payload: (required)
        :type create_access_policy_payload: CreateAccessPolicyPayload
        ...
        _param = self._create_access_policy_serialize(
            ...
            create_access_policy_payload=create_access_policy_payload,
    ...
    def _create_access_policy_serialize(
        ...
        if create_access_policy_payload is not None:
            _body_params = create_access_policy_payload
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/v1/projects/{projectId}/regions/{regionId}/instances/{instanceId}/access-policies",
    ...
    def delete_access_policy(
        ...
        region_id: Annotated[StrictStr, Field(description="The STACKIT region name the resource is located in.")],
        instance_id: Annotated[UUID, Field(description="The Logs Instance UUID.")],
        p_id: Annotated[UUID, Field(description="The access policy unique id.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param instance_id: The Logs Instance UUID. (required)
        :type instance_id: UUID
        :param p_id: The access policy unique id. (required)
        :type p_id: UUID
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._delete_access_policy_serialize(
            project_id=project_id,
            region_id=region_id,
            instance_id=instance_id,
            p_id=p_id,
    ...
    @validate_call
    def delete_access_policy_with_http_info(
        self,
        project_id: Annotated[UUID, Field(description="The STACKIT portal project UUID the resource is located in.")],
        region_id: Annotated[StrictStr, Field(description="The STACKIT region name the resource is located in.")],
        instance_id: Annotated[UUID, Field(description="The Logs Instance UUID.")],
    ...
    @validate_call
    def delete_access_policy_without_preload_content(
        self,
        project_id: Annotated[UUID, Field(description="The STACKIT portal project UUID the resource is located in.")],
        region_id: Annotated[StrictStr, Field(description="The STACKIT region name the resource is located in.")],
        instance_id: Annotated[UUID, Field(description="The Logs Instance UUID.")],
    ...
    def _delete_access_policy_serialize(
        self,
        project_id,
        region_id,
        instance_id,
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/v1/projects/{projectId}/regions/{regionId}/instances/{instanceId}/access-policies/{pId}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_all_access_policies(
        self,
        project_id: Annotated[UUID, Field(description="The STACKIT portal project UUID the resource is located in.")],
        region_id: Annotated[StrictStr, Field(description="The STACKIT region name the resource is located in.")],
        instance_id: Annotated[UUID, Field(description="The Logs Instance UUID.")],
        ...
        _param = self._delete_all_access_policies_serialize(
            project_id=project_id,
            region_id=region_id,
            instance_id=instance_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def delete_all_access_policies_with_http_info(
        self,
        project_id: Annotated[UUID, Field(description="The STACKIT portal project UUID the resource is located in.")],
        region_id: Annotated[StrictStr, Field(description="The STACKIT region name the resource is located in.")],
        instance_id: Annotated[UUID, Field(description="The Logs Instance UUID.")],
    ...
    @validate_call
    def delete_all_access_policies_without_preload_content(
        self,
        project_id: Annotated[UUID, Field(description="The STACKIT portal project UUID the resource is located in.")],
        region_id: Annotated[StrictStr, Field(description="The STACKIT region name the resource is located in.")],
        instance_id: Annotated[UUID, Field(description="The Logs Instance UUID.")],
    ...
    def _delete_all_access_policies_serialize(
        self,
        project_id,
        region_id,
        instance_id,
    ...
    def get_access_policy(
        ...
        _param = self._get_access_policy_serialize(
            project_id=project_id,
            region_id=region_id,
            instance_id=instance_id,
            p_id=p_id,
    ...
    @validate_call
    def get_access_policy_with_http_info(
        self,
        project_id: Annotated[UUID, Field(description="The STACKIT portal project UUID the resource is located in.")],
        region_id: Annotated[StrictStr, Field(description="The STACKIT region name the resource is located in.")],
        instance_id: Annotated[UUID, Field(description="The Logs Instance UUID.")],
    ...
    @validate_call
    def get_access_policy_without_preload_content(
        self,
        project_id: Annotated[UUID, Field(description="The STACKIT portal project UUID the resource is located in.")],
        region_id: Annotated[StrictStr, Field(description="The STACKIT region name the resource is located in.")],
        instance_id: Annotated[UUID, Field(description="The Logs Instance UUID.")],
    ...
    def _get_access_policy_serialize(
        self,
        project_id,
        region_id,
        instance_id,
    ...
    def list_access_policies(
        ...
        _param = self._list_access_policies_serialize(
            project_id=project_id,
            region_id=region_id,
            instance_id=instance_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def list_access_policies_with_http_info(
        self,
        project_id: Annotated[UUID, Field(description="The STACKIT portal project UUID the resource is located in.")],
        region_id: Annotated[StrictStr, Field(description="The STACKIT region name the resource is located in.")],
        instance_id: Annotated[UUID, Field(description="The Logs Instance UUID.")],
    ...
    @validate_call
    def list_access_policies_without_preload_content(
        self,
        project_id: Annotated[UUID, Field(description="The STACKIT portal project UUID the resource is located in.")],
        region_id: Annotated[StrictStr, Field(description="The STACKIT region name the resource is located in.")],
        instance_id: Annotated[UUID, Field(description="The Logs Instance UUID.")],
    ...
    def _list_access_policies_serialize(
        self,
        project_id,
        region_id,
        instance_id,
    ...
    def update_access_policy(
        ...
        instance_id: Annotated[UUID, Field(description="The Logs Instance UUID.")],
        p_id: Annotated[UUID, Field(description="The access policy unique id.")],
        update_access_policy_payload: UpdateAccessPolicyPayload,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param p_id: The access policy unique id. (required)
        :type p_id: UUID
        :param update_access_policy_payload: (required)
        :type update_access_policy_payload: UpdateAccessPolicyPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_access_policy_serialize(
            ...
            instance_id=instance_id,
            p_id=p_id,
            update_access_policy_payload=update_access_policy_payload,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    def _update_access_policy_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_access_policy_payload is not None:
            _body_params = update_access_policy_payload
