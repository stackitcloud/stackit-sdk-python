...
class RequestedSubscriptionStateResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequestedSubscriptionStateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequestedSubscriptionStateResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"lifecycleState": obj.get("lifecycleState"), "subscriptionId": obj.get("subscriptionId")}
        )
        return _obj
