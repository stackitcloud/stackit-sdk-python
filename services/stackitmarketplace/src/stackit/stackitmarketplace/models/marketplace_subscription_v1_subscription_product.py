...
class MarketplaceSubscriptionV1SubscriptionProduct(BaseModel):
    ...
    notice_period: StrictStr = Field(
        description="The cancellation notice period of the subscription.", alias="noticePeriod"
    )
    ...
    rate: StrictStr = Field(description="The price of the product (per unit).")
    validity_period: StrictStr = Field(
        description="The period the subscription is valid for before it will be renewed.", alias="validityPeriod"
    )
