...
class CatalogProductSupportResource(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CatalogProductSupportResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CatalogProductSupportResource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"supportLink": obj.get("supportLink"), "supportLinkTitle": obj.get("supportLinkTitle")}
        )
        return _obj
