...
class CreateServiceAccountPayload(BaseModel):
    """
    CreateServiceAccountPayload
    """

    name: Annotated[str, Field(min_length=1, strict=True, max_length=20)] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateServiceAccountPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateServiceAccountPayload from a dict"""
        if obj is None:
            return None
