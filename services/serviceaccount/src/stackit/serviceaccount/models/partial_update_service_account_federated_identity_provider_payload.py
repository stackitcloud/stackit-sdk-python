...
class PartialUpdateServiceAccountFederatedIdentityProviderPayload(BaseModel):
    """
    PartialUpdateServiceAccountFederatedIdentityProviderPayload
    """  # noqa: E501

    assertions: Optional[List[CreateFederatedIdentityProviderPayloadAssertionsInner]] = Field(
        default=None, description="list of assertions of the federated identity provider"
    )
    issuer: StrictStr = Field(description="Issuer of the federated identity provider.")
    name: StrictStr = Field(description="Unique name used as identifier of the federated identity provider.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PartialUpdateServiceAccountFederatedIdentityProviderPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PartialUpdateServiceAccountFederatedIdentityProviderPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "assertions": (
                    [
                        CreateFederatedIdentityProviderPayloadAssertionsInner.from_dict(_item)
