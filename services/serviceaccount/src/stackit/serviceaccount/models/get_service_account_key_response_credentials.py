...
class GetServiceAccountKeyResponseCredentials(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetServiceAccountKeyResponseCredentials from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetServiceAccountKeyResponseCredentials from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"aud": obj.get("aud"), "iss": obj.get("iss"), "kid": obj.get("kid"), "sub": obj.get("sub")}
        )
        return _obj
