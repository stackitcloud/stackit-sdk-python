...
class CreateServiceAccountKeyResponse(BaseModel):
    """
    ...
    public_key: StrictStr = Field(
        description="Public key, that was provider, or was generated by the service account API", alias="publicKey"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateServiceAccountKeyResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateServiceAccountKeyResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "credentials": (
                    CreateServiceAccountKeyResponseCredentials.from_dict(obj["credentials"])
