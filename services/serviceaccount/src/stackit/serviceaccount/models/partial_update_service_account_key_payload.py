...
class PartialUpdateServiceAccountKeyPayload(BaseModel):
    """
    PartialUpdateServiceAccountKeyPayload
    """

    active: Optional[StrictBool] = Field(
        default=None, description="Active keys are valid, while inactive keys are temporarily deactivated."
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PartialUpdateServiceAccountKeyPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PartialUpdateServiceAccountKeyPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"active": obj.get("active"), "validUntil": obj.get("validUntil")})
        return _obj
