...
class CreateFederatedIdentityProviderPayloadAssertionsInner(BaseModel):
    """
    CreateFederatedIdentityProviderPayloadAssertionsInner
    """  # noqa: E501

    item: Optional[StrictStr] = Field(default=None, description="Item to compare")
    operator: Optional[StrictStr] = Field(default=None, description="Operator for the comparison")
    value: Optional[StrictStr] = Field(default=None, description="Value which the item is compared to")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateFederatedIdentityProviderPayloadAssertionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateFederatedIdentityProviderPayloadAssertionsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"item": obj.get("item"), "operator": obj.get("operator"), "value": obj.get("value")})
        return _obj
