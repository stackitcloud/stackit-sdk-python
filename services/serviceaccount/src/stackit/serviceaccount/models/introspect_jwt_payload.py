...
class IntrospectJWTPayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["token", "token_type_hint"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IntrospectJWTPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IntrospectJWTPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"token": obj.get("token"), "token_type_hint": obj.get("token_type_hint")})
        return _obj
