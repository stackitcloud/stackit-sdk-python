...
class JWK(BaseModel):
    ...
    n: StrictStr
    ops: Optional[StrictStr] = None
    use: Optional[StrictStr] = None
    x5c: Optional[StrictStr] = None
    x5t: Optional[StrictStr] = None
    x5t256: Optional[StrictStr] = None
    x5u: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["alg", "e", "kid", "ks", "n", "ops", "use", "x5c", "x5t", "x5t256", "x5u"]
