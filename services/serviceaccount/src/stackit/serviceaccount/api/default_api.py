...
class DefaultApi:
    ...
    @validate_call
    def create_federated_identity_provider(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project.")],
        service_account_email: Annotated[StrictStr, Field(description="The email of the service account.")],
        create_federated_identity_provider_payload: Annotated[
            Optional[CreateFederatedIdentityProviderPayload], Field(description="Federated identity provider request")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param service_account_email: The email of the service account. (required)
        :type service_account_email: str
        :param create_federated_identity_provider_payload: Federated identity provider request
        :type create_federated_identity_provider_payload: CreateFederatedIdentityProviderPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_federated_identity_provider_serialize(
            project_id=project_id,
            service_account_email=service_account_email,
            create_federated_identity_provider_payload=create_federated_identity_provider_payload,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def create_federated_identity_provider_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project.")],
        service_account_email: Annotated[StrictStr, Field(description="The email of the service account.")],
        create_federated_identity_provider_payload: Annotated[
    ...
    @validate_call
    def create_federated_identity_provider_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project.")],
        service_account_email: Annotated[StrictStr, Field(description="The email of the service account.")],
        create_federated_identity_provider_payload: Annotated[
    ...
    def _create_federated_identity_provider_serialize(
        self,
        project_id,
        service_account_email,
        ...
        # process the form parameters
        # process the body parameter
        if create_federated_identity_provider_payload is not None:
            _body_params = create_federated_identity_provider_payload
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/v2/projects/{projectId}/service-accounts/{serviceAccountEmail}/federations",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_service_federated_identity_provider(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project.")],
        service_account_email: Annotated[StrictStr, Field(description="The email of the service account.")],
        federation_id: Annotated[StrictStr, Field(description="ID of the Federated Identity Provider.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        """Delete a service account Federated Identity Provider
        ...
        _param = self._delete_service_federated_identity_provider_serialize(
            project_id=project_id,
            service_account_email=service_account_email,
    ...
    @validate_call
    def delete_service_federated_identity_provider_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project.")],
        service_account_email: Annotated[StrictStr, Field(description="The email of the service account.")],
        federation_id: Annotated[StrictStr, Field(description="ID of the Federated Identity Provider.")],
    ...
    @validate_call
    def delete_service_federated_identity_provider_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project.")],
        service_account_email: Annotated[StrictStr, Field(description="The email of the service account.")],
        federation_id: Annotated[StrictStr, Field(description="ID of the Federated Identity Provider.")],
    ...
    def _delete_service_federated_identity_provider_serialize(
        self,
        project_id,
        service_account_email,
        federation_id,
    ...
    @validate_call
    def list_federated_identity_providers(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project.")],
        service_account_email: Annotated[StrictStr, Field(description="The email of the service account.")],
        _request_timeout: Union[
        ...
        _param = self._list_federated_identity_providers_serialize(
            project_id=project_id,
            service_account_email=service_account_email,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "FederatedListFederatedIdentityProvidersResponse",
            "400": "Error",
            "401": "AuthError",
            "403": "AuthError",
            "500": "Error",
    ...
    @validate_call
    def list_federated_identity_providers_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project.")],
        service_account_email: Annotated[StrictStr, Field(description="The email of the service account.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FederatedListFederatedIdentityProvidersResponse]:
        """List all federated identity providers
    ...
    @validate_call
    def list_federated_identity_providers_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project.")],
        service_account_email: Annotated[StrictStr, Field(description="The email of the service account.")],
        _request_timeout: Union[
    ...
    def _list_federated_identity_providers_serialize(
        self,
        project_id,
        service_account_email,
        _request_auth,
    ...
    @validate_call
    def partial_update_service_account_federated_identity_provider(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project.")],
        service_account_email: Annotated[StrictStr, Field(description="The email of the service account.")],
        federation_id: Annotated[StrictStr, Field(description="ID of the Federated Identity Provider.")],
        partial_update_service_account_federated_identity_provider_payload: Annotated[
            Optional[PartialUpdateServiceAccountFederatedIdentityProviderPayload],
            Field(description="Delete a Federated Identity Provider"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param federation_id: ID of the Federated Identity Provider. (required)
        :type federation_id: str
        :param partial_update_service_account_federated_identity_provider_payload: Delete a Federated Identity Provider
        :type partial_update_service_account_federated_identity_provider_payload: PartialUpdateServiceAccountFederatedIdentityProviderPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._partial_update_service_account_federated_identity_provider_serialize(
            project_id=project_id,
            service_account_email=service_account_email,
            federation_id=federation_id,
            partial_update_service_account_federated_identity_provider_payload=partial_update_service_account_federated_identity_provider_payload,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def partial_update_service_account_federated_identity_provider_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project.")],
        service_account_email: Annotated[StrictStr, Field(description="The email of the service account.")],
        federation_id: Annotated[StrictStr, Field(description="ID of the Federated Identity Provider.")],
    ...
    @validate_call
    def partial_update_service_account_federated_identity_provider_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project.")],
        service_account_email: Annotated[StrictStr, Field(description="The email of the service account.")],
        federation_id: Annotated[StrictStr, Field(description="ID of the Federated Identity Provider.")],
    ...
    def _partial_update_service_account_federated_identity_provider_serialize(
        self,
        project_id,
        service_account_email,
        federation_id,
        ...
        # process the form parameters
        # process the body parameter
        if partial_update_service_account_federated_identity_provider_payload is not None:
            _body_params = partial_update_service_account_federated_identity_provider_payload
