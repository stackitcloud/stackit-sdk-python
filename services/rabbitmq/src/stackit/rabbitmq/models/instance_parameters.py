...
class InstanceParameters(BaseModel):
    ...
    roles: Optional[List[StrictStr]] = Field(
        default=None, description="This property is deprecated and will be removed in a future release."
    )
    ...
    tls_protocols: Optional[List[StrictStr]] = Field(
        default=None,
        description="This property is deprecated and will be removed in a future release.",
        alias="tls-protocols",
    )
    ...
    def plugins_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(
                ...
                raise ValueError(
                    "each list item must be one of ('rabbitmq_consistent_hash_exchange', 'rabbitmq_federation', 'rabbitmq_federation_management', 'rabbitmq_mqtt', 'rabbitmq_sharding', 'rabbitmq_shovel', 'rabbitmq_shovel_management', 'rabbitmq_stomp', 'rabbitmq_event_exchange')"
                )
        return value
