...
class Credentials(BaseModel):
    ...
    http_api_uri: Optional[StrictStr] = Field(default=None, description="for rabbitmq only")
    http_api_uris: Optional[List[StrictStr]] = None
    management: Optional[StrictStr] = None
    mqtt: Optional[StrictStr] = None
    password: StrictStr
    port: Optional[StrictInt] = None
    stomp: Optional[StrictStr] = None
        ...
        _obj = cls.model_validate(
            {
                "host": obj.get("host"),
                "hosts": obj.get("hosts"),
                "http_api_uri": obj.get("http_api_uri"),
                "http_api_uris": obj.get("http_api_uris"),
