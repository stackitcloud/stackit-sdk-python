...
import stackit.modelexperiments.models
from stackit.modelexperiments import rest
from stackit.modelexperiments.api_response import ApiResponse
from stackit.modelexperiments.api_response import T as ApiResponseT
from stackit.modelexperiments.configuration import HostConfiguration
from stackit.modelexperiments.exceptions import (
    ApiException,
)
...
class ApiClient:
    ...
    def __init__(self, configuration, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "stackit-sdk-python/modelexperiments"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.modelexperiments.models, klass)
