...
class DeleteInstanceResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["instance", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteInstanceResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteInstanceResponse from a dict"""
        if obj is None:
            return None
