...
class ErrorResponse(BaseModel):
    ...
    message: StrictStr = Field(description="User facing error message.")
    status: Optional[StrictStr] = Field(default=None, description="The canonical error code.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"code": obj.get("code"), "message": obj.get("message"), "status": obj.get("status")})
        return _obj
