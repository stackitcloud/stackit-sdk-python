...
class ListInstanceResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["instances", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListInstanceResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListInstanceResponse from a dict"""
        if obj is None:
            return None
