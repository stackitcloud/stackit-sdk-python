...
class HttpCheckResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HttpCheckResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.http_checks:
            for _item_http_checks in self.http_checks:
                if _item_http_checks:
                    _items.append(_item_http_checks.to_dict())
            _dict["httpChecks"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HttpCheckResponse from a dict"""
        if obj is None:
            return None
