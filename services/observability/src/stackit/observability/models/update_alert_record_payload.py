...
class UpdateAlertRecordPayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["expr", "labels"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateAlertRecordPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateAlertRecordPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"expr": obj.get("expr"), "labels": obj.get("labels")})
        return _obj
