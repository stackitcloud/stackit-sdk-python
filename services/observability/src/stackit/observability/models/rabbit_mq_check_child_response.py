...
class RabbitMQCheckChildResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "password", "url", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RabbitMQCheckChildResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RabbitMQCheckChildResponse from a dict"""
        if obj is None:
            return None
