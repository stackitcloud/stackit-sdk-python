...
class CertCheckResponse(BaseModel):
    """
    CertCheckResponse
    """  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CertCheckResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.cert_checks:
            for _item_cert_checks in self.cert_checks:
                if _item_cert_checks:
                    _items.append(_item_cert_checks.to_dict())
            _dict["certChecks"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CertCheckResponse from a dict"""
        if obj is None:
            return None
