...
import stackit.observability.models
from stackit.observability import rest
from stackit.observability.api_response import ApiResponse
from stackit.observability.api_response import T as ApiResponseT
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.observability.models, klass)
