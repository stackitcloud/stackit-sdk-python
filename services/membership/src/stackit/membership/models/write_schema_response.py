...
class WriteSchemaResponse(BaseModel):
    """
    WriteSchemaResponse
    """

    written_at: Zookie = Field(alias="writtenAt")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WriteSchemaResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WriteSchemaResponse from a dict"""
        if obj is None:
            return None
