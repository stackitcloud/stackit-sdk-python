...
class EnforcePermissionPayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["actions", "consistency", "resource", "resourceType", "subject"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnforcePermissionPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnforcePermissionPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "consistency": (
                    Consistency.from_dict(obj["consistency"]) if obj.get("consistency") is not None else None
                ),
