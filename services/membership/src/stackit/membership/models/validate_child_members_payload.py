...
class ValidateChildMembersPayload(BaseModel):
    """
    ValidateChildMembersPayload
    """

    child_resource_type: Annotated[str, Field(strict=True)] = Field(alias="childResourceType")
    members: List[Member]
    resource_type: Annotated[str, Field(strict=True)] = Field(alias="resourceType")
    __properties: ClassVar[List[str]] = ["childResourceType", "members", "resourceType"]

    @field_validator("child_resource_type")
    def child_resource_type_validate_regular_expression(cls, value):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidateChildMembersPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidateChildMembersPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "childResourceType": obj.get("childResourceType"),
                "members": (
