...
class AddRolesPayloadItem(BaseModel):
    """
    AddRolesPayloadItem
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddRolesPayloadItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddRolesPayloadItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "name": obj.get("name"),
                "permissions": (
                    [PermissionRequest.from_dict(_item) for _item in obj["permissions"]]
