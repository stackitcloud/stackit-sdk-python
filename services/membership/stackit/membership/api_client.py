...
import stackit.membership.models
from stackit.membership import rest
from stackit.membership.api_response import ApiResponse
from stackit.membership.api_response import T as ApiResponseT
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.membership.models, klass)
