...
class Resource(BaseModel):
    ...
    resource_alias: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(
        default=None, alias="resourceAlias"
    )
    ...
    __properties: ClassVar[List[str]] = ["resourceAlias", "resourceId", "resourceType"]
