...
class CreateResourcePayload(BaseModel):
    ...
    parent_type: Annotated[str, Field(strict=True)] = Field(alias="parentType")
    ...
    __properties: ClassVar[List[str]] = ["members", "parentId", "parentType", "resourceAlias", "resourceId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateResourcePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateResourcePayload from a dict"""
        if obj is None:
            return None
