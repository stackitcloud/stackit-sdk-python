...
class CreateNetworkIPv6Body(BaseModel):
    """
    ...
    prefix: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None, description="Classless Inter-Domain Routing (CIDR) for IPv6."
    )
    prefix_length: Optional[Annotated[int, Field(le=128, strict=True, ge=56)]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateNetworkIPv6Body from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateNetworkIPv6Body from a dict"""
        if obj is None:
            return None
