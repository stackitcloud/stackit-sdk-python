...
class ServerMaintenance(BaseModel):
    """
    ...
    def ends_at_change_year_zero_to_one(cls, value):
    ...
    def starts_at_change_year_zero_to_one(cls, value):
        """Workaround which prevents year 0 issue"""
        if isinstance(value, str):
            # Check for year "0000" at the beginning of the string
            # This assumes common date formats like YYYY-MM-DDTHH:MM:SS+00:00 or YYYY-MM-DDTHH:MM:SSZ
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServerMaintenance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServerMaintenance from a dict"""
        if obj is None:
            return None
