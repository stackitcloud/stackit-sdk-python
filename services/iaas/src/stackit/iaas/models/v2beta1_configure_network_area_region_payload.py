...
class V2beta1ConfigureNetworkAreaRegionPayload(BaseModel):
    """
    The basic properties of a regional network area.
    """  # noqa: E501

    ipv4: Optional[RegionalAreaIPv4] = None
    ...
    __properties: ClassVar[List[str]] = ["ipv4", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2beta1ConfigureNetworkAreaRegionPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2beta1ConfigureNetworkAreaRegionPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "ipv4": RegionalAreaIPv4.from_dict(obj["ipv4"]) if obj.get("ipv4") is not None else None,
