...
class ManagementRouteDestination(BaseModel):
    """
    ManagementRouteDestination
    """  # noqa: E501

    type: StrictStr
    value: Annotated[str, Field(strict=True)] = Field(description="An CIDRv6 string.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ManagementRouteDestination from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ManagementRouteDestination from a dict"""
        if obj is None:
            return None
