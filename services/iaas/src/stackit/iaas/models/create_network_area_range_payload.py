...
class CreateNetworkAreaRangePayload(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateNetworkAreaRangePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateNetworkAreaRangePayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"ipv4": [NetworkRange.from_dict(_item) for _item in obj["ipv4"]] if obj.get("ipv4") is not None else None}
        )
        return _obj
