...
class RegionalAreaListResponse(BaseModel):
    """
    Regional area list response.
    """  # noqa: E501

    regions: Dict[str, RegionalArea]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegionalAreaListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegionalAreaListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "regions": (
                    dict((_k, RegionalArea.from_dict(_v)) for _k, _v in obj["regions"].items())
