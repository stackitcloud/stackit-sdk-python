...
class PublicNetwork(BaseModel):
    ...
    region: StrictStr = Field(description="Name of the region.")
    __properties: ClassVar[List[str]] = ["cidr", "region"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"cidr": obj.get("cidr"), "region": obj.get("region")})
        return _obj
