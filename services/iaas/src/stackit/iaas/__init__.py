...
from stackit.iaas.models.v2beta1_configure_network_area_region_payload import (
    V2beta1ConfigureNetworkAreaRegionPayload as V2beta1ConfigureNetworkAreaRegionPayload,
)
from stackit.iaas.models.v2beta1_create_snapshot_payload import (
    V2beta1CreateSnapshotPayload as V2beta1CreateSnapshotPayload,
)
from stackit.iaas.models.v2beta1_update_backup_payload import (
    V2beta1UpdateBackupPayload as V2beta1UpdateBackupPayload,
)
from stackit.iaas.models.v2beta1_update_network_area_region_payload import (
    V2beta1UpdateNetworkAreaRegionPayload as V2beta1UpdateNetworkAreaRegionPayload,
)
from stackit.iaas.models.v2beta1_update_route_of_area_payload import (
    V2beta1UpdateRouteOfAreaPayload as V2beta1UpdateRouteOfAreaPayload,
)
from stackit.iaas.models.v2beta1_update_security_group_payload import (
    V2beta1UpdateSecurityGroupPayload as V2beta1UpdateSecurityGroupPayload,
)
from stackit.iaas.models.v2beta1_update_snapshot_payload import (
    V2beta1UpdateSnapshotPayload as V2beta1UpdateSnapshotPayload,
)
