...
import stackit.intake.models
from stackit.intake import rest
from stackit.intake.api_response import ApiResponse
from stackit.intake.api_response import T as ApiResponseT
from stackit.intake.configuration import HostConfiguration
from stackit.intake.exceptions import (
    ApiException,
)
...
class ApiClient:
    ...
    def __init__(self, configuration, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "stackit-sdk-python/intake"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.intake.models, klass)
