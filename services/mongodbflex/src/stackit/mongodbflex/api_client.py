...
import stackit.mongodbflex.models
from stackit.mongodbflex import rest
from stackit.mongodbflex.api_response import ApiResponse
from stackit.mongodbflex.api_response import T as ApiResponseT
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.mongodbflex.models, klass)
