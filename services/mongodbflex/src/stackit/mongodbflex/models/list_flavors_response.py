...
from stackit.mongodbflex.models.instance_flavor import InstanceFlavor
...
class ListFlavorsResponse(BaseModel):
    ...
    flavors: Optional[List[InstanceFlavor]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "flavors": (
                    [InstanceFlavor.from_dict(_item) for _item in obj["flavors"]]
