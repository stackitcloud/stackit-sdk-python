...
class DefaultApi:
    ...
    def delete_access_token(
        ...
        region_id: Annotated[StrictStr, Field(description="The STACKIT region name the resource is located in.")],
        telemetry_router_id: Annotated[UUID, Field(description="The Telemetry Router UUID.")],
        access_id_id: Annotated[UUID, Field(description="The Access Token UUID.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param telemetry_router_id: The Telemetry Router UUID. (required)
        :type telemetry_router_id: UUID
        :param access_id_id: The Access Token UUID. (required)
        :type access_id_id: UUID
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _delete_access_token_serialize(
        ...
        if access_id_id is not None:
            _path_params["accessIdId"] = access_id_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/v1/projects/{projectId}/regions/{regionId}/telemetry-routers/{telemetryRouterId}/access-tokens/{accessIdId}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_access_tokens(
        ...
        :param telemetry_router_id: The Telemetry Router UUID. (required)
        :type telemetry_router_id: UUID
        :param page_id: A token to retrieve the next page of results.
        :type page_id: str
