...
import stackit.telemetryrouter.models
from stackit.telemetryrouter import rest
from stackit.telemetryrouter.api_response import ApiResponse
from stackit.telemetryrouter.api_response import T as ApiResponseT
from stackit.telemetryrouter.configuration import HostConfiguration
from stackit.telemetryrouter.exceptions import (
    ApiException,
)
...
class ApiClient:
    ...
    def __init__(self, configuration, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "stackit-sdk-python/telemetryrouter"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.telemetryrouter.models, klass)
