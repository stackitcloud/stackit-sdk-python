...
class InstanceParameters(BaseModel):
    ...
    min_replicas_to_write: Optional[StrictInt] = Field(
        default=1,
    ...
    repl_backlog_size: Optional[StrictStr] = Field(
        default="1mb", description="Set the replication backlog size for the cluster.", alias="repl-backlog-size"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "min-replicas-to-write": (
                    obj.get("min-replicas-to-write") if obj.get("min-replicas-to-write") is not None else 1
                ),
                "min_replicas_max_lag": (
                ...
                "repl-backlog-size": (
                    obj.get("repl-backlog-size") if obj.get("repl-backlog-size") is not None else "1mb"
                ),
