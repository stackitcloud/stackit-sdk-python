...
import stackit.valkey.models
from stackit.valkey import rest
from stackit.valkey.api_response import ApiResponse
from stackit.valkey.api_response import T as ApiResponseT
from stackit.valkey.configuration import HostConfiguration
from stackit.valkey.exceptions import (
    ApiException,
)
...
class ApiClient:
    ...
    def __init__(self, configuration, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "stackit-sdk-python/valkey"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.valkey.models, klass)
