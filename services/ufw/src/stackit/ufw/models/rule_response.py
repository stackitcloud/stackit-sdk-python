...
class RuleResponse(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="The current state of the resource.")
    type: StrictStr
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(["Active", "Error", "Pending", "Updating", "Deleting", "Creating"]):
            raise ValueError(
