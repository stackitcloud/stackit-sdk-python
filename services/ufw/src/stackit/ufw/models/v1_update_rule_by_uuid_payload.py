...
class V1UpdateRuleByUuidPayload(BaseModel):
    """
    The request body for updating a security rule.
    """  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1UpdateRuleByUuidPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1UpdateRuleByUuidPayload from a dict"""
        if obj is None:
            return None
