...
class SecurityRuleResponse(BaseModel):
    ...
    success: Optional[StrictBool] = Field(default=None, description="Represents if the call was successfully made")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SecurityRuleResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SecurityRuleResponse from a dict"""
        if obj is None:
            return None
