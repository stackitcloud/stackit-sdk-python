...
import stackit.ufw.models
from stackit.ufw import rest
from stackit.ufw.api_response import ApiResponse
from stackit.ufw.api_response import T as ApiResponseT
from stackit.ufw.configuration import HostConfiguration
from stackit.ufw.exceptions import (
    ApiException,
)
...
class ApiClient:
    ...
    def __init__(self, configuration, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "stackit-sdk-python/ufw"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.ufw.models, klass)
