...
class RedactedCredentials(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RedactedCredentials from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RedactedCredentials from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"access_key": obj.get("access_key")})
        return _obj
