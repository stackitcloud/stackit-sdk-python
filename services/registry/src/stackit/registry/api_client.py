...
import stackit.registry.models
from stackit.registry import rest
from stackit.registry.api_response import ApiResponse
from stackit.registry.api_response import T as ApiResponseT
from stackit.registry.configuration import HostConfiguration
from stackit.registry.exceptions import (
    ApiException,
)
...
class ApiClient:
    ...
    def __init__(self, configuration, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "stackit-sdk-python/registry"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.registry.models, klass)
