...
class ImportKeyPayload(BaseModel):
    """
    ImportKeyPayload
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImportKeyPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImportKeyPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"wrappedKey": obj.get("wrappedKey"), "wrappingKeyId": obj.get("wrappingKeyId")})
        return _obj
