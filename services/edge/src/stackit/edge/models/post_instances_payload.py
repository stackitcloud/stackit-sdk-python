...
class PostInstancesPayload(BaseModel):
    """
    PostInstancesPayload
    """  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostInstancesPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostInstancesPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"description": obj.get("description"), "displayName": obj.get("displayName"), "planId": obj.get("planId")}
        )
        return _obj
