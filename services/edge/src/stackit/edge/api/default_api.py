...
from stackit.edge.models.post_instances_payload import PostInstancesPayload
...
class DefaultApi:
    ...
    def post_instances(
        ...
        project_id: Annotated[StrictStr, Field(description="The STACKIT portal project UUID the instance is part of.")],
        region_id: Annotated[StrictStr, Field(description="The STACKIT region the instance is part of.")],
        post_instances_payload: PostInstancesPayload,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param region_id: The STACKIT region the instance is part of. (required)
        :type region_id: str
        :param post_instances_payload: (required)
        :type post_instances_payload: PostInstancesPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_instances_serialize(
            project_id=project_id,
            region_id=region_id,
            post_instances_payload=post_instances_payload,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def post_instances_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The STACKIT portal project UUID the instance is part of.")],
        region_id: Annotated[StrictStr, Field(description="The STACKIT region the instance is part of.")],
        post_instances_payload: PostInstancesPayload,
    ...
    @validate_call
    def post_instances_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The STACKIT portal project UUID the instance is part of.")],
        region_id: Annotated[StrictStr, Field(description="The STACKIT region the instance is part of.")],
        post_instances_payload: PostInstancesPayload,
    ...
    def _post_instances_serialize(
        self,
        project_id,
        region_id,
        post_instances_payload,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_instances_payload is not None:
            _body_params = post_instances_payload
