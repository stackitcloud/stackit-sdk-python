...
import stackit.edge.models
from stackit.edge import rest
from stackit.edge.api_response import ApiResponse
from stackit.edge.api_response import T as ApiResponseT
from stackit.edge.configuration import HostConfiguration
from stackit.edge.exceptions import (
    ApiException,
)
...
class ApiClient:
    ...
    def __init__(self, configuration, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "stackit-sdk-python/edge"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.edge.models, klass)
