...
class AuditLogEntryInitiatorResponse(BaseModel):
    """
    Information about who made the request.
    """  # noqa: E501

    email: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(
        default=None, description="E-Mail of the user or service account who triggered the request"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuditLogEntryInitiatorResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuditLogEntryInitiatorResponse from a dict"""
        if obj is None:
            return None
