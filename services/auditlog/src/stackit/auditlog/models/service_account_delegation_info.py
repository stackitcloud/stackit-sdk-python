...
class ServiceAccountDelegationInfo(BaseModel):
    ...
    principals: List[DelegationPrincipal] = Field(description="Delegation chain for the service account")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "principals": (
                    [DelegationPrincipal.from_dict(_item) for _item in obj["principals"]]
