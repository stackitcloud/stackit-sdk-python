...
class ServiceAccountDelegationInfoPrincipalResponse(BaseModel):
    """
    Principal in delegation chain of a service account
    """  # noqa: E501

    email: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(
        default=None, description="E-Mail of the subject"
    )
    id: StrictStr = Field(description="Unique identifier of the subject")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServiceAccountDelegationInfoPrincipalResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServiceAccountDelegationInfoPrincipalResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"email": obj.get("email"), "id": obj.get("id")})
        return _obj
