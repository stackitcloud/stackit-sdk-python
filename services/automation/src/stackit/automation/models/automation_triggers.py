...
class AutomationTriggers(BaseModel):
    ...
    schedule: Optional[AutomationScheduleTrigger] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AutomationTriggers from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AutomationTriggers from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "schedule": (
                    AutomationScheduleTrigger.from_dict(obj["schedule"]) if obj.get("schedule") is not None else None
                )
            }
        )
        return _obj
