...
class ListTemplatesResponse(BaseModel):
    ...
    next_page_token: Optional[StrictStr] = Field(
        default=None,
        description="A token that can be sent as `pageToken` to retrieve the next page. If this field is omitted, there are no subsequent pages.",
        alias="nextPageToken",
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "items": (
                    [Template.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
                ),
