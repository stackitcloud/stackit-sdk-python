...
class AutomationScheduleTrigger(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["rrule"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AutomationScheduleTrigger from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AutomationScheduleTrigger from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"rrule": obj.get("rrule")})
        return _obj
