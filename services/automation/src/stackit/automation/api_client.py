...
import stackit.automation.models
from stackit.automation import rest
from stackit.automation.api_response import ApiResponse
from stackit.automation.api_response import T as ApiResponseT
from stackit.automation.configuration import HostConfiguration
from stackit.automation.exceptions import (
    ApiException,
)
...
class ApiClient:
    ...
    def __init__(self, configuration, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "stackit-sdk-python/automation"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.automation.models, klass)
