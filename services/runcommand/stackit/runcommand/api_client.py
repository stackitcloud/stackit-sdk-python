...
import stackit.runcommand.models
from stackit.runcommand import rest
from stackit.runcommand.api_response import ApiResponse
from stackit.runcommand.api_response import T as ApiResponseT
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.runcommand.models, klass)
