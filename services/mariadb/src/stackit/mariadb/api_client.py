...
import stackit.mariadb.models
from stackit.mariadb import rest
from stackit.mariadb.api_response import ApiResponse
from stackit.mariadb.api_response import T as ApiResponseT
...
class ApiClient:
    ...
    def __init__(self, configuration, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "stackit-sdk-python/mariadb"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.mariadb.models, klass)
