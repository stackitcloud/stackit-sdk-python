...
class CreateRecordSetPayload(BaseModel):
    """
    ...
    ttl: Optional[Annotated[int, Field(le=99999999, strict=True, ge=60)]] = Field(
        default=None, description="time to live. If nothing provided we will set the zone ttl."
    )
    type: StrictStr = Field(description="record set type")
    __properties: ClassVar[List[str]] = ["comment", "name", "records", "ttl", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateRecordSetPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateRecordSetPayload from a dict"""
        if obj is None:
            return None
