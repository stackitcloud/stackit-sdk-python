...
class ZoneExtensions(BaseModel):
    """
    ZoneExtensions
    """

    observability_extension: Optional[ZoneObservabilityExtension] = Field(default=None, alias="observabilityExtension")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ZoneExtensions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ZoneExtensions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "observabilityExtension": (
                    ZoneObservabilityExtension.from_dict(obj["observabilityExtension"])
