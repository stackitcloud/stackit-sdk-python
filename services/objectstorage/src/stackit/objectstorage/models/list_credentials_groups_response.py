...
class ListCredentialsGroupsResponse(BaseModel):
    """
    ListCredentialsGroupsResponse
    """

    credentials_groups: List[CredentialsGroup] = Field(alias="credentialsGroups")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListCredentialsGroupsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListCredentialsGroupsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "credentialsGroups": (
                    [CredentialsGroup.from_dict(_item) for _item in obj["credentialsGroups"]]
                    if obj.get("credentialsGroups") is not None
                    else None
                ),
