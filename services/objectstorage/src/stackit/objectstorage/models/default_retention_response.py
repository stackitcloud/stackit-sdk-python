...
class DefaultRetentionResponse(BaseModel):
    """
    DefaultRetentionResponse
    """  # noqa: E501

    bucket: StrictStr = Field(description="Name of the bucket")
    days: StrictInt = Field(description="Retention period in days")
    mode: RetentionMode
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DefaultRetentionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DefaultRetentionResponse from a dict"""
        if obj is None:
            return None
