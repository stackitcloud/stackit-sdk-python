...
import stackit.postgresflex.models
from stackit.postgresflex import rest
from stackit.postgresflex.api_response import ApiResponse
from stackit.postgresflex.api_response import T as ApiResponseT
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.postgresflex.models, klass)
