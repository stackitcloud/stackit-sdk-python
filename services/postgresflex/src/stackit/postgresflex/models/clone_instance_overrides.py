...
class CloneInstanceOverrides(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CloneInstanceOverrides from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CloneInstanceOverrides from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"class": obj.get("class"), "name": obj.get("name"), "size": obj.get("size")})
        return _obj
