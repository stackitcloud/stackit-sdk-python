...
class ProjectCostsWithDetailedServices(BaseModel):
    """
    ...
    services: Optional[List[DetailedServiceCosts]] = Field(
        default=None,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectCostsWithDetailedServices from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectCostsWithDetailedServices from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "services": (
                    [DetailedServiceCosts.from_dict(_item) for _item in obj["services"]]
