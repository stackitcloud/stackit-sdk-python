...
class ProjectCostsWithSummarizedServices(BaseModel):
    """
    ...
    services: Optional[List[SummarizedServiceCosts]] = Field(default=None, description="Summarized service costs")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectCostsWithSummarizedServices from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectCostsWithSummarizedServices from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "services": (
                    [SummarizedServiceCosts.from_dict(_item) for _item in obj["services"]]
