...
class CreateSpaceRolePayload(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["space_auditor", "space_developer", "space_manager", "space_supporter"]):
            raise ValueError(
                "must be one of enum values ('space_auditor', 'space_developer', 'space_manager', 'space_supporter')"
            )
        return value
