...
import stackit.scf.models
from stackit.scf import rest
from stackit.scf.api_response import ApiResponse
from stackit.scf.api_response import T as ApiResponseT
from stackit.scf.configuration import HostConfiguration
from stackit.scf.exceptions import (
    ApiException,
)
...
class ApiClient:
    ...
    def __init__(self, configuration, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "stackit-sdk-python/scf"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.scf.models, klass)
