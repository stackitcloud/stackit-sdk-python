...
import stackit.logme.models
from stackit.logme import rest
from stackit.logme.api_response import ApiResponse
from stackit.logme.api_response import T as ApiResponseT
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.logme.models, klass)
