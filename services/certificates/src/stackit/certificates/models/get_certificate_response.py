...
class GetCertificateResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "publicKey"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetCertificateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetCertificateResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"id": obj.get("id"), "name": obj.get("name"), "publicKey": obj.get("publicKey")})
        return _obj
