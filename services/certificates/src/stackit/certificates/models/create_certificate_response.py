...
class CreateCertificateResponse(BaseModel):
    """
    CreateCertificateResponse returns unique resource id
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "region"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateCertificateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateCertificateResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"id": obj.get("id"), "region": obj.get("region")})
        return _obj
