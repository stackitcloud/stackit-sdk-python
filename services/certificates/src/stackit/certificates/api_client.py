...
import stackit.certificates.models
from stackit.certificates import rest
from stackit.certificates.api_response import ApiResponse
from stackit.certificates.api_response import T as ApiResponseT
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.certificates.models, klass)
