...
import stackit.modelserving.models
from stackit.modelserving import rest
from stackit.modelserving.api_response import ApiResponse
from stackit.modelserving.api_response import T as ApiResponseT
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.modelserving.models, klass)
