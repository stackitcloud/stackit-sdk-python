...
class ListFoldersResponseItemsInner(BaseModel):
    """
    ...
    parent: Parent
    update_time: datetime = Field(description="Timestamp at which the folder was created.", alias="updateTime")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListFoldersResponseItemsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListFoldersResponseItemsInner from a dict"""
        if obj is None:
            return None
