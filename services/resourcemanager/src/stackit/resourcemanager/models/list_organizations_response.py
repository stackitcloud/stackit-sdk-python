...
class ListOrganizationsResponse(BaseModel):
    ...
    items: List[ListOrganizationsResponseItemsInner]
    limit: Union[
    ...
    offset: Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "items": (
                    [ListOrganizationsResponseItemsInner.from_dict(_item) for _item in obj["items"]]
