...
import stackit.resourcemanager.models
from stackit.resourcemanager import rest
from stackit.resourcemanager.api_response import ApiResponse
from stackit.resourcemanager.api_response import T as ApiResponseT
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.resourcemanager.models, klass)
