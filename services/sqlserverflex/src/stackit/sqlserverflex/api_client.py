...
import stackit.sqlserverflex.models
from stackit.sqlserverflex import rest
from stackit.sqlserverflex.api_response import ApiResponse
from stackit.sqlserverflex.api_response import T as ApiResponseT
...
class ApiClient:
    ...
    def __init__(self, configuration, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "stackit-sdk-python/sqlserverflex"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.sqlserverflex.models, klass)
