...
class ListBackupsResponse(BaseModel):
    ...
    backups: List[ListBackup] = Field(description="List of the backups beloning to that database")
    database_name: StrictStr = Field(description="Name of the database the backups belong to", alias="databaseName")
    __properties: ClassVar[List[str]] = ["backups", "databaseName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "backups": (
                    [ListBackup.from_dict(_item) for _item in obj["backups"]]
