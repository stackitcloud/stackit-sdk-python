...
class UpdateInstancePayload(BaseModel):
    ...
    acl: InstanceDocumentationACL = Field(
    ...
    labels: Dict[str, Any] = Field(description="Labels for the instance")
    name: StrictStr = Field(description="Name of the instance")
    version: StrictStr = Field(description="Version of the MSSQL Server")
