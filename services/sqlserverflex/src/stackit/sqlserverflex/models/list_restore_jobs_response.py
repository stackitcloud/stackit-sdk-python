...
class ListRestoreJobsResponse(BaseModel):
    ...
    running_restores: Optional[List[RestoreRunningRestore]] = Field(default=None, alias="runningRestores")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "runningRestores": (
                    [RestoreRunningRestore.from_dict(_item) for _item in obj["runningRestores"]]
