...
class ListFlavorsResponse(BaseModel):
    ...
    flavors: List[ListFlavors] = Field(description="List of flavors available for the project.")
    pagination: Pagination
    __properties: ClassVar[List[str]] = ["flavors", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "flavors": (
                    [ListFlavors.from_dict(_item) for _item in obj["flavors"]]
