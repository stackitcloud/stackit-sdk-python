...
class GetDatabaseResponse(BaseModel):
    ...
    collation_name: StrictStr = Field(
    ...
    compatibility_level: StrictInt = Field(
        description="CompatibilityLevel of the Database.", alias="compatibilityLevel"
    )
    ...
    __properties: ClassVar[List[str]] = ["collationName", "compatibilityLevel", "id", "name", "owner"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDatabaseResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDatabaseResponse from a dict"""
        if obj is None:
            return None
