...
class CreateDatabasePayload(BaseModel):
    ...
    collation: Optional[StrictStr] = Field(
        default=None,
    ...
    compatibility: Optional[StrictInt] = Field(default=None, description="CompatibilityLevel of the Database.")
    name: StrictStr = Field(description="The name of the database.")
    owner: StrictStr = Field(description="The owner of the database.")
    __properties: ClassVar[List[str]] = ["collation", "compatibility", "name", "owner"]
