...
class ListDatabasesResponse(BaseModel):
    ...
    databases: List[ListDatabase] = Field(description="A list containing all databases for the instance.")
    pagination: Pagination
    __properties: ClassVar[List[str]] = ["databases", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "databases": (
                    [ListDatabase.from_dict(_item) for _item in obj["databases"]]
