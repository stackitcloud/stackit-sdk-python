...
class BackupListBackupsResponseGrouped(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BackupListBackupsResponseGrouped from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BackupListBackupsResponseGrouped from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "backups": (
                    [Backup.from_dict(_item) for _item in obj["backups"]] if obj.get("backups") is not None else None
                ),
                "name": obj.get("name"),
            }
        )
