...
class DremioResponse(BaseModel):
    """
    DremioResponse
    """  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DremioResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DremioResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "authentication": (
                    Authentication.from_dict(obj["authentication"]) if obj.get("authentication") is not None else None
                ),
                "create_time": obj.get("create_time"),
                "description": obj.get("description"),
                "displayName": obj.get("displayName"),
                "endpoints": Endpoints.from_dict(obj["endpoints"]) if obj.get("endpoints") is not None else None,
