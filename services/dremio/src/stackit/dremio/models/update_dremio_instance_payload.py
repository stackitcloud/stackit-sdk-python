...
class UpdateDremioInstancePayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["authentication", "description", "displayName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateDremioInstancePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateDremioInstancePayload from a dict"""
        if obj is None:
            return None
