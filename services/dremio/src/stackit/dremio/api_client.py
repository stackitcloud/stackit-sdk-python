...
import stackit.dremio.models
from stackit.dremio import rest
from stackit.dremio.api_response import ApiResponse
from stackit.dremio.api_response import T as ApiResponseT
from stackit.dremio.configuration import HostConfiguration
from stackit.dremio.exceptions import (
    ApiException,
)
...
class ApiClient:
    ...
    def __init__(self, configuration, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "stackit-sdk-python/dremio"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.dremio.models, klass)
