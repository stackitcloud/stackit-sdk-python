...
class Volume(BaseModel):
    ...
    size: Annotated[int, Field(le=10240, strict=True, ge=20)]
    ...
    __properties: ClassVar[List[str]] = ["size", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"size": obj.get("size"), "type": obj.get("type")})
        return _obj
