...
class Extension(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["acl", "argus", "dns"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of argus
        if self.argus:
            _dict["argus"] = self.argus.to_dict()
        ...
        _obj = cls.model_validate(
            {
                ...
                "argus": Argus.from_dict(obj["argus"]) if obj.get("argus") is not None else None,
