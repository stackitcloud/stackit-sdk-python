...
from stackit.ske.models.expiration_status import ExpirationStatus
        ...
        _obj = cls.model_validate(
            {
                ...
                "expiration": (
                    ExpirationStatus.from_dict(obj["expiration"]) if obj.get("expiration") is not None else None
                ),
