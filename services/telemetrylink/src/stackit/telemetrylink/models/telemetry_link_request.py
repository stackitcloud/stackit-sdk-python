...
class TelemetryLinkRequest(BaseModel):
    ...
    access_id: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None, description="The access token.", alias="accessId"
    )
    ...
    __properties: ClassVar[List[str]] = ["accessId", "description", "displayName", "enabled", "telemetryRouterId"]

    @field_validator("access_id")
    def access_id_validate_regular_expression(cls, value):
