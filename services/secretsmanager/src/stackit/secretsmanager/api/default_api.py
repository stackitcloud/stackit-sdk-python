...
class DefaultApi:
    ...
    def create_approle_secret(
        ...
        instance_id: Annotated[StrictStr, Field(description="The Secrets Manager instance UUID.")],
        role_id: Annotated[
            StrictStr, Field(description="The approle with permissions on the Secrets Manager instance.")
        ],
        create_approle_secret_payload: CreateApproleSecretPayload,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :type role_id: str
        :param create_approle_secret_payload: (required)
        :type create_approle_secret_payload: CreateApproleSecretPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_approle_secret_serialize(
            project_id=project_id,
            instance_id=instance_id,
            role_id=role_id,
            create_approle_secret_payload=create_approle_secret_payload,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def create_approle_secret_with_http_info(
        self,
        project_id: Annotated[
            StrictStr, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    @validate_call
    def create_approle_secret_without_preload_content(
        self,
        project_id: Annotated[
            StrictStr, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    def _create_approle_secret_serialize(
        self,
        project_id,
        instance_id,
        role_id,
        create_approle_secret_payload,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if create_approle_secret_payload is not None:
            _body_params = create_approle_secret_payload
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/v1/projects/{projectId}/instances/{instanceId}/approles/{roleId}/secrets",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_approle_secret(
        ...
        secret_version: Annotated[StrictInt, Field(description="The secret version.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param role_id: The approle with permissions on the Secrets Manager instance. (required)
        :type role_id: str
        :param secret_version: The secret version. (required)
        ...
        _param = self._delete_approle_secret_serialize(
            project_id=project_id,
            instance_id=instance_id,
            role_id=role_id,
    ...
    @validate_call
    def delete_approle_secret_with_http_info(
        self,
        project_id: Annotated[
            StrictStr, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    @validate_call
    def delete_approle_secret_without_preload_content(
        self,
        project_id: Annotated[
            StrictStr, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    def _delete_approle_secret_serialize(
        self,
        project_id,
        instance_id,
        role_id,
        ...
        if secret_version is not None:
            _path_params["secretVersion"] = secret_version
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/v1/projects/{projectId}/instances/{instanceId}/approles/{roleId}/secrets/{secretVersion}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_approle_secret(
        ...
        _param = self._get_approle_secret_serialize(
            project_id=project_id,
            instance_id=instance_id,
            role_id=role_id,
            secret_version=secret_version,
    ...
    @validate_call
    def get_approle_secret_with_http_info(
        self,
        project_id: Annotated[
            StrictStr, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    def _get_approle_secret_serialize(
        self,
        project_id,
        instance_id,
        role_id,
    ...
    def list_approle_secrets(
        ...
        _param = self._list_approle_secrets_serialize(
            project_id=project_id,
            instance_id=instance_id,
            role_id=role_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def list_approle_secrets_with_http_info(
        self,
        project_id: Annotated[
            StrictStr, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    @validate_call
    def list_approle_secrets_without_preload_content(
        self,
        project_id: Annotated[
            StrictStr, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    def _list_approle_secrets_serialize(
        self,
        project_id,
        instance_id,
        role_id,
