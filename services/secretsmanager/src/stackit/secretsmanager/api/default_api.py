...
from stackit.secretsmanager.models.create_approle_secret_id_payload import (
    CreateApproleSecretIdPayload,
)
...
from stackit.secretsmanager.models.update_approle_secret_id_payload import (
    UpdateApproleSecretIdPayload,
)
...
class DefaultApi:
    ...
    def create_approle(
        ...
        instance_id: Annotated[UUID, Field(description="The Secrets Manager instance UUID.")],
        create_approle_payload: CreateApprolePayload,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :type create_approle_payload: CreateApprolePayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_approle_serialize(
            project_id=project_id,
            instance_id=instance_id,
            create_approle_payload=create_approle_payload,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def create_approle_with_http_info(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    @validate_call
    def create_approle_without_preload_content(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    def _create_approle_serialize(
        self,
        project_id,
        instance_id,
        create_approle_payload,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if create_approle_payload is not None:
            _body_params = create_approle_payload
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/v1/projects/{projectId}/instances/{instanceId}/approles",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def create_approle_secret_id(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
        instance_id: Annotated[UUID, Field(description="The Secrets Manager instance UUID.")],
        role_id: Annotated[UUID, Field(description="The approle with permissions on the Secrets Manager instance.")],
        create_approle_secret_id_payload: CreateApproleSecretIdPayload,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param instance_id: The Secrets Manager instance UUID. (required)
        :type instance_id: UUID
        :param role_id: The approle with permissions on the Secrets Manager instance. (required)
        :type role_id: UUID
        :param create_approle_secret_id_payload: (required)
        :type create_approle_secret_id_payload: CreateApproleSecretIdPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_approle_secret_id_serialize(
            project_id=project_id,
            instance_id=instance_id,
            role_id=role_id,
            create_approle_secret_id_payload=create_approle_secret_id_payload,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def create_approle_secret_id_with_http_info(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    @validate_call
    def create_approle_secret_id_without_preload_content(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    def _create_approle_secret_id_serialize(
        self,
        project_id,
        instance_id,
        role_id,
        ...
        # process the form parameters
        # process the body parameter
        if create_approle_secret_id_payload is not None:
            _body_params = create_approle_secret_id_payload
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/v1/projects/{projectId}/instances/{instanceId}/approles/{roleId}/secretids",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_approle(
        ...
        _param = self._delete_approle_serialize(
            project_id=project_id,
            instance_id=instance_id,
            role_id=role_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def delete_approle_with_http_info(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    @validate_call
    def delete_approle_without_preload_content(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    def _delete_approle_serialize(
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/v1/projects/{projectId}/instances/{instanceId}/approles/{roleId}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_approle_secret_id(
        ...
        instance_id: Annotated[UUID, Field(description="The Secrets Manager instance UUID.")],
        role_id: Annotated[UUID, Field(description="The approle with permissions on the Secrets Manager instance.")],
        secret_id_version: Annotated[StrictInt, Field(description="The version of the secret id.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param role_id: The approle with permissions on the Secrets Manager instance. (required)
        :type role_id: UUID
        :param secret_id_version: The version of the secret id. (required)
        :type secret_id_version: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_approle_secret_id_serialize(
            project_id=project_id,
            instance_id=instance_id,
            role_id=role_id,
            secret_id_version=secret_id_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def delete_approle_secret_id_with_http_info(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    @validate_call
    def delete_approle_secret_id_without_preload_content(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    def _delete_approle_secret_id_serialize(
        self,
        project_id,
        instance_id,
        role_id,
        ...
        if role_id is not None:
            _path_params["roleId"] = role_id
        if secret_id_version is not None:
            _path_params["secretIdVersion"] = secret_id_version
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/v1/projects/{projectId}/instances/{instanceId}/approles/{roleId}/secretids/{secretIdVersion}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_approle(
        ...
        _param = self._get_approle_serialize(
            project_id=project_id,
            instance_id=instance_id,
            role_id=role_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_approle_with_http_info(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    @validate_call
    def get_approle_without_preload_content(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    def get_approle_secret_id(
        ...
        _param = self._get_approle_secret_id_serialize(
            project_id=project_id,
            instance_id=instance_id,
            role_id=role_id,
            secret_id_version=secret_id_version,
    ...
    @validate_call
    def get_approle_secret_id_with_http_info(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    @validate_call
    def get_approle_secret_id_without_preload_content(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    def _get_approle_secret_id_serialize(
        self,
        project_id,
        instance_id,
        role_id,
    ...
    def get_approles(
        ...
        _param = self._get_approles_serialize(
            project_id=project_id,
            instance_id=instance_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_approles_with_http_info(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    @validate_call
    def get_approles_without_preload_content(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    def list_approle_secret_ids(
        ...
        _param = self._list_approle_secret_ids_serialize(
            project_id=project_id,
            instance_id=instance_id,
            role_id=role_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def list_approle_secret_ids_with_http_info(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    @validate_call
    def list_approle_secret_ids_without_preload_content(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    def _list_approle_secret_ids_serialize(
        self,
        project_id,
        instance_id,
        role_id,
    ...
    def update_approle(
        ...
        instance_id: Annotated[UUID, Field(description="The Secrets Manager instance UUID.")],
        role_id: Annotated[UUID, Field(description="The approle with permissions on the Secrets Manager instance.")],
        update_approle_payload: UpdateApprolePayload,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param role_id: The approle with permissions on the Secrets Manager instance. (required)
        :type role_id: UUID
        :param update_approle_payload: (required)
        :type update_approle_payload: UpdateApprolePayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_approle_serialize(
            ...
            instance_id=instance_id,
            role_id=role_id,
            update_approle_payload=update_approle_payload,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def update_approle_with_http_info(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    def _update_approle_serialize(
        self,
        project_id,
        instance_id,
        role_id,
        update_approle_payload,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_approle_payload is not None:
            _body_params = update_approle_payload
    ...
    def update_approle_secret_id(
        ...
        role_id: Annotated[UUID, Field(description="The approle with permissions on the Secrets Manager instance.")],
        secret_id_version: Annotated[StrictInt, Field(description="The version of the secret id.")],
        update_approle_secret_id_payload: UpdateApproleSecretIdPayload,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param secret_id_version: The version of the secret id. (required)
        :type secret_id_version: int
        :param update_approle_secret_id_payload: (required)
        :type update_approle_secret_id_payload: UpdateApproleSecretIdPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_approle_secret_id_serialize(
            project_id=project_id,
            instance_id=instance_id,
            role_id=role_id,
            secret_id_version=secret_id_version,
            update_approle_secret_id_payload=update_approle_secret_id_payload,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def update_approle_secret_id_with_http_info(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    @validate_call
    def update_approle_secret_id_without_preload_content(
        self,
        project_id: Annotated[
            UUID, Field(description="The STACKIT portal project UUID the Secrets Manager instance is part of.")
        ],
    ...
    def _update_approle_secret_id_serialize(
        self,
        project_id,
        instance_id,
        role_id,
        secret_id_version,
        update_approle_secret_id_payload,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_approle_secret_id_payload is not None:
            _body_params = update_approle_secret_id_payload
