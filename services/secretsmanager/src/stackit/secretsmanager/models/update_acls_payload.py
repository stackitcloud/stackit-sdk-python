...
class UpdateACLsPayload(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateACLsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateACLsPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "cidrs": (
                    [UpdateACLPayload.from_dict(_item) for _item in obj["cidrs"]]
                    if obj.get("cidrs") is not None
                    else None
                )
            }
        )
