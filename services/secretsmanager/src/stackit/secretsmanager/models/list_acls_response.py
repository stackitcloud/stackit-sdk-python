...
class ListACLsResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListACLsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListACLsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"acls": [ACL.from_dict(_item) for _item in obj["acls"]] if obj.get("acls") is not None else None}
        )
        return _obj
