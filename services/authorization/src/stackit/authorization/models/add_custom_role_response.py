...
class AddCustomRoleResponse(BaseModel):
    """
    ...
    role: Role
    __properties: ClassVar[List[str]] = ["resourceId", "resourceType", "role"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddCustomRoleResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddCustomRoleResponse from a dict"""
        if obj is None:
            return None
