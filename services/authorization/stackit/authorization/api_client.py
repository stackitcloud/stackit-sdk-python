...
import stackit.authorization.models
from stackit.authorization import rest
from stackit.authorization.api_response import ApiResponse
from stackit.authorization.api_response import T as ApiResponseT
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stackit.authorization.models, klass)
